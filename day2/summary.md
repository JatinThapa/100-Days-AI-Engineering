# Day 2 - Building a Local AI Chatbot with Memory using Ollama
...
And after every model response:
...
```text
hi there, my name is jatin!
```

Assistant:

```text
Hi Jatin! It's nice to meet you!
```
...
```text
Your name is Jatin! I remember, we met earlier when you said hello.
```

This confirmed that the chatbot was successfully maintaining conversation history.
